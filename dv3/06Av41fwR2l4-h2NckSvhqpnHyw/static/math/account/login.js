...
(function() {
  ...
  // Case 115969: Focus password input field while username has been filled.
  var resetFocusForUsernamePassword = function(inputUserNameId, inputPasswordId) {
  ...
  loginDialog.callback.success = function(o) {
    ...
    resetFocusForUsernamePassword("username", "password");
  };
  ...
  (function() {
    ...
    loginDialog.validate = function() {
      ...
      if (!Dom.get("familyUserId")) {
        if (disallowBlank(Dom.get("username"), "", true) ||
            disallowBlank(Dom.get("password"), "", true)) {
