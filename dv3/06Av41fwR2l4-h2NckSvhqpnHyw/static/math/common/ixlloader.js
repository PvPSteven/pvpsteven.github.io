    ...
    info: {
      ...
      moduleInfo: {
        ...
        "login": {
          ...
          requires: ["cookie", "flowdialog", "get", "ixlutils", "moment"],
        ...
        "moment": {
          type: "js",
          path: "../moment/dist-2.8.4/moment.js",
          varName: "moment"
        },
        ...
        "manageaccount" : {
          ...
          requires: ["admin", "datasource", "datatable", "slider", "flowdialog", "limitdatescalendar", "moment"]
        },
        ...
        "adminreports": {
          ...
          requires: ["admin", "dom", "event", "flowdialog", "datatable", "limitdatescalendar", "stylesheet", "moment"],
